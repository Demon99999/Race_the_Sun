...
namespace RaseTheSun.Scripts.Gameplay.Spaceship.Battery.Indicator
{
    public class BatteryIndicator : MonoBehaviour
    {
        private const float PercentageBeforeDischargeStart = 0.3f;
        private const int OneHundredPercent = 1;
